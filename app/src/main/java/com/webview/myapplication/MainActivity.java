...
import com.worldinova.acictsdiary.R;
...
// or disable cookies in general
        ...
        if (isNetworkAvailable()) {
            //mWebView.loadUrl("https://diary-acicts.replit.app");
            openBrowser();
        } else {
...
/*
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://diary-acicts.replit.app"));
...
*/
        ...
        builder.setToolbarColor(ContextCompat.getColor(this, R.color.back));
        builder.enableUrlBarHiding();
        CustomTabsIntent customTabsIntent = builder.build();
        customTabsIntent.launchUrl(this, Uri.parse("https://diary-acicts.replit.app"));
